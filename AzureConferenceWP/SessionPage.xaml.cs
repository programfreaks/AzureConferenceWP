...
namespace AzureConferenceWP
{
    public partial class SessionPage : PhoneApplicationPage
    {
        ...
        private void appbar_add_calendar_Click(object sender, EventArgs e)
        {
            ...
            //saveAppointmentTask.StartTime = DateTime.Parse(show.AiredOn);
            //saveAppointmentTask.EndTime = saveAppointmentTask.StartTime.Value.AddMinutes(60);
            //saveAppointmentTask.Subject = "TV Shows Reminder";
            //saveAppointmentTask.Location = show.Name;
            //saveAppointmentTask.Details = builder.ToString();
